...
class Model(nn.Module):
    def __init__(self):
        ...
        self.classifyW = nn.Sequential(
            nn.Linear(fdim, fdim*2, bias=True),
            nn.ReLU(),
            nn.Linear(fdim*2, n_classes, bias=True)
        )
    ...
    def forward(self):
        ...
        D2 = self.W(self.D2)
        x2 = D2.mm(D2.t())
        score_classify1 = F.log_softmax(self.classifyW(self.D1), dim=1)
        score_classify2 = F.log_softmax(self.classifyW(self.D2), dim=1)

...
save_graphs(A, X, L, f"data-transfers/synf/Atrain-Xtrain")
# G(Xtest, f(Xtest))
_, X, L = test_graphs[0]
...
A[A>=0.5] = 1
A[A<0.5] = 0
save_graphs(A, X, L, f"data-transfers/synf/A2-Xtest")
# G(Xtest, KNN(Xtest))
_, X, L = test_graphs[0]
...
# G(Xtest, Atest)
A, X, L = test_graphs[0]
save_graphs(A, X, L, f"data-transfers/synf/Atest-Xtest")
